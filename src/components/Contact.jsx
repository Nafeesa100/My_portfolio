...
const SERVICE_ID = "service_iiroqg6"
const TEMPLATE_ID = "template_y7874md"
const PUBLIC_KEY = "g0vr-UwH6vLKoPRdK"
        ...
        <div className="contact-info reveal">
          ...
          <div className="contact-item">
            ...
            <div className="contact-item-text">
              <a href="mailto:nafeesa22111@gmail.com">nafeesa22111@gmail.com</a>
            </div>
          </div>
          <div className="contact-item">
            <div className="contact-icon">💼</div>
