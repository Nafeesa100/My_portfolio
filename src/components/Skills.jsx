...
const skills = [
  ...
  { icon: '▲', name: 'Vercel', level: 'Deployment', pct: 85 },
  { icon: '🤖', name: 'n8n', level: 'AI Automation', pct: 82 },
  { icon: '📮', name: 'Postman', level: 'API Testing', pct: 84 },
  { icon: '🧠', name: 'OpenAI API', level: 'AI Integration', pct: 80 },
]
  ...
  return (
    <section id="skills" className="skills-section">
      ...
      <div className="skills-grid">
        {skills.map((s) => (
          <div className="skill-card reveal" key={s.name} data-pct={`${s.pct}%`}>
